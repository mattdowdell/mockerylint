...
// NewMockLegacy creates a new instance of MockLegacy. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockLegacy(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockLegacy {
	mock := &MockLegacy{}
...
// MockLegacy is an autogenerated mock type for the Legacy type, generated without
// with-expecter, so it has no EXPECT method.
