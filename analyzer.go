...
func visitWithContext(pass *analysis.Pass, node ast.Node, stack []ast.Node, generated map[*ast.File]bool) {
	...
	case *ast.CompositeLit:
		visitCompositeLit(pass, n)
	case *ast.ValueSpec:
		visitValueSpec(pass, n)
	}
}
...
func visitCallExpr(pass *analysis.Pass, call *ast.CallExpr, stack []ast.Node) {
	...
	checkMockMethodCall(pass, selector, stack)
}
...
func checkMockMethodCall(pass *analysis.Pass, selector *ast.SelectorExpr, stack []ast.Node) {
...
func visitValueSpec(pass *analysis.Pass, spec *ast.ValueSpec) {
